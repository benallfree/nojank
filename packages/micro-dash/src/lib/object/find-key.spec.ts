...
describe('findKey()', () => {
  it('has fancy typing', () => {
    ...
    expectTypeOf(findKey(oOrU, keyIsString)).toEqualTypeOf<string | undefined>()
    expectTypeOf(findKey(oOrN, keyIsString)).toEqualTypeOf<string | undefined>()
    ...
    expectTypeOf(findKey(sOrU, keyIsAorNumber)).toEqualTypeOf<'a' | undefined>()
    expectTypeOf(findKey(sOrN, keyIsAorNumber)).toEqualTypeOf<'a' | undefined>()
    expectTypeOf(findKey(o, keyIsAorNumber)).toEqualTypeOf<'a'>()
    expectTypeOf(findKey(oOrU, keyIsAorNumber)).toEqualTypeOf<'a' | undefined>()
    expectTypeOf(findKey(oOrN, keyIsAorNumber)).toEqualTypeOf<'a' | undefined>()

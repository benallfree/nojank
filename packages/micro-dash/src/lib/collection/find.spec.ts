...
describe('find()', () => {
  it('has fancy typing for arrays', () => {
    ...
    expectTypeOf(find(a, isDateOrString, 1)).toEqualTypeOf<string | undefined>()
    expectTypeOf(find(aOrU, isDateOrString)).toEqualTypeOf<string | undefined>()
    expectTypeOf(find(aOrU, isDateOrString, 1)).toEqualTypeOf<
      string | undefined
    >()
    expectTypeOf(find(aOrN, isDateOrString)).toEqualTypeOf<string | undefined>()
  ...
  it('has fancy typing for objects', () => {
    ...
    expectTypeOf(find(s, keyIsAorNumber, 1)).toEqualTypeOf<number | undefined>()
    expectTypeOf(find(sOrU, keyIsAorNumber)).toEqualTypeOf<number | undefined>()
    expectTypeOf(find(sOrU, keyIsAorNumber, 1)).toEqualTypeOf<
      number | undefined
    >()
    expectTypeOf(find(sOrN, keyIsAorNumber)).toEqualTypeOf<number | undefined>()
  ...
  it('should work with an array and a `fromIndex` >= `length`', () => {
    ...
    for (const key of [1, undefined, '']) {
      for (const fromIndex of [4, 6, 2 ** 32, Infinity]) {
        expect(find(array, (n) => Object.is(n, key), fromIndex)).toBe(undefined)
      }
    }
  })
